    ...
    return (
        <div className='py-6'>
            <nav className=' container mx-auto grid gap-3 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 md:px-6 '>
                ...
                <nav className='relative flex bg-orange-900/80 item-center gap-3 text-white justify-between  p-5 py-10 ring-1 ring-offset-2 ring-offset-info-200 ring-white  rounded-md '>
                    <nav className='flex flex-col my-auto gap-1 px-1'>
                        ...
                        <nav className='text-blue-100 font-bold flex items-center gap-2 w-full  '>
                            <nav className=' px-2 flex items-center '>
                                {formatnumber(dashboardData ? dashboardData?.unattended_products?.products : 0)}
                            </nav>
                            {dashboardData?.unattended_products?.products > 0 && <nav className=' flex items-center text-xs text-red-200 bg-red-600 p-1 '>
                                <Link to="/stockmanagement/unattended">
                                    MANAGE {`->`}
                                </Link>
                            </nav>}
                    ...
                    <IconifyIcon className="!h-12 !w-12 !text-white" fontSize='4rem' icon="hugeicons:package-out-of-stock" />
                    <StatsBgIcon />
                </nav>
