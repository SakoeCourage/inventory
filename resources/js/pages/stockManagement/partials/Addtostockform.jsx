...
function Addtostockform({ stockData, fetchAllData, setShowStockingModal }) {
  ...
  const handleSubmission = () => {
    Api.post(`product/stock/${stockData.model.id}/increase`, formData)
      .then(res => {
  ...
  return (
    <div className='w-full h-full min-h-max !overflow-y-scroll text-blue-950 px-2 py-5 flex flex-col gap-5 '>
      <Fieldset className="flex flex-col gap-4 my-auto">
        <nav className='border-b border-gray-300 border-dotted addleftline '>
        ...
        <div className='  addleftline flex  flex-col justify-center gap-5 py-5 shadow-md rounded-sm '>
