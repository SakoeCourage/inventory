...
import Productreportsummarized from './Productreportsummarized';
import Productreportdetailed from './Productreportdetailed';
import { Tooltip } from '@mui/material';

const reportTypes = {
    'Summarized': Productreportsummarized,
    'Long': Productreportdetailed
}

export default function Productreportview(props) {
    ...
    const Component = reportTypes[props?.reportType]
    ...
    return <div ref={toPrint} className='toPrint overflow-scroll hiddenscroll w-[1200px] mx-auto h-full p-5 py-10 font-mono '>
