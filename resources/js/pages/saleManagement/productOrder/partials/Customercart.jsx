...
function Customercart({ productsFromDB, modelsFromDB, formData, setFormData, items, setItems, errors }) {
    ...
    return (
        <div className='h-[30rem] overflow-y-scroll hiddenscroll'>
            {Boolean(items.length) && <div id='lineitemsContainer' className=' w-full '>
                <nav className='w-full text-gray-500 grid grid-cols-8 gap-1 sticky top-0 bg-orange-50/50 z-20  font-medium py-1 border-b'>
